<main class="sortByProducts-container all-padding mt-4 ">
                        ...
                        <div class="form_control">
                            <div class="form_control_container">
                                ...
                                <input class="form_control_container__time__input" type="number" id="fromInput"
                                    readonly value="10" min="0" max="2000" />
                            </div>
                            <div class="form_control_container">
                                ...
                                <input class="form_control_container__time__input" type="number" id="toInput"
                                    readonly value="2000" min="0" max="2000" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <article>
        <section class="sortbtn-container w-100border border-danger">
            ...
            <div class="dropdown">
                <button class="sortby-btn" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown"
                    aria-expanded="false">
                ...
                <ul class="dropdown-menu sortbybtn-drop" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" style="width: 178px" href="#">Vegetables</a></li>
                    <li><a class="dropdown-item" href="#">Fruits</a></li>
                    <li><a class="dropdown-item" href="#">Bakery</a></li>
                </ul>
            </div>
        </section>
        <section class="sortby-products mt-4">
            @include('components.productCollection')
            @include('components.productCollection')
            @include('components.productCollection')

        </section>
        <section class="pagination-container d-flex">
            <div class="pagination"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    viewBox="0 0 24 24" style="fill: #08bc3f;transform: ;msFilter:;">
                    <path d="M12.707 17.293 8.414 13H18v-2H8.414l4.293-4.293-1.414-1.414L4.586 12l6.707 6.707z"></path>
                </svg></div>
            <div class="pagination">1</div>
            <div class="pagination-active">2</div>
            <div class="pagination">3</div>
            <div class="pagination-gap d-flex align-items-center" style="color: black;">. . .</div>
