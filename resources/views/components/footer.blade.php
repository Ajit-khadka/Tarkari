<main class="footer-wrapper d-flex flex-column justify-content-between">
    <article class="footer all-padding d-flex justify-content-between mt-5">
        <section class="aboutcompany-footer">
            <div>
                <span class="footer-title text-uppercase">Tarkari</span><br>
                <div class="mt-4">
                    <span class="footer-desc">As our name suggests, we supply every one of our customers with the ozone
                        washed, freshest and highest quality fruit and vegetables.</span><br><br>
                    <span class="footer-desc">We achieve our quality through a rigorous selection of farms and farmers
                        and suppliers who share our vision of best quality, as well as our insistence on operationg a
                        short supply chain. </span>
                </div>
            </div>

        </section>
        <section class="footerlink-container">
            <p class="footer-title">Our Services</p>
            <ul class="footer-links list-inline mt-4">
                <li><a class="store button" href="#">Store</a></li>
                <li><a class="button" href="#">Contact Us</a></li>
                <li><a class="button" href="#">About</a></li>
                <li><a class="button" href="#">Delivery</a></li>
                <li><a class="button" href="#">Blogs</a></li>
                <li><a class="button" href="#">Terms and Conditions</a></li>
            </ul>
        </section>
    ...
    <div class="copyright-container mt-5 d-flex  flex-column align-items-center">
        <div class="footer-line mb-4"></div>
        <p class="copyright-footer all-padding pb-2"><span class="me-2">Copyright</span> 2022 Designed and Developed
            by <span class="name-footer">Tarkari</span></p>
    </div>
</main>
